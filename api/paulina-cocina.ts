...
import { scrapeOpenGraphTags, fetchAndScrape, getIngredientsList, getStepsList } from "./_utils.js";
...
function scraper(document: Document): Recipe {
	...
	const ingredientsListElem = getIngredientsList(document, "#ingredientes ~ ul");
